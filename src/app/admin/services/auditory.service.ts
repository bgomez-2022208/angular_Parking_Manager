...
export class AuditoryService {
  ...
  getAuditoryByEntity(
    ...
    return this.http
      ...
      .pipe(
        tap(audits =>
          console.log('Auditorías recibidas filtradas por entidad:', audits)
        ),
        catchError(error => {
          console.error(
            'Error al obtener auditorías filtradas por entidad:',
            error
          );
          throw error;
        })
  ...
  getAuditoryByDateRange(
    ...
    return this.http
      ...
      .pipe(
        ...
        catchError(error => {
          console.error(
            'Error al obtener las auditorías por rango de fechas:',
            error
          );
          throw error;
        })
