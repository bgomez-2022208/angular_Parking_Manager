...
describe('AuditoriaComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      imports: [
        HttpClientTestingModule,MatDatepickerModule,MatNativeDateModule,MatPaginatorModule,MatToolbarModule,
        TranslateModule.forRoot(),MatIconModule,MatMenuModule,
